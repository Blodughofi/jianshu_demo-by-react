...
export default class Write extends Component{
    ...
    titleChange(ev){this.setState({titleVal : ev.target.value})}
    cltChange(ev){this.setState({cltVal : ev.target.value})}
    contentChange(ev){this.setState({contentVal : ev.target.value})}
    ...
    onSubmit(ev){
        ...
        let {value: cltId} = this.refs.cltInput;
    ...
    render(){
        ...
        let {titleChange,cltChange,contentChange,collectionName,onSubmit,addCollection} = this;
